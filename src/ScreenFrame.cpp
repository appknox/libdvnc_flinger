...
static android::status_t setDisplayProjection(
 ...
 */
static android::status_t prepareVirtualDisplay(const android::DisplayInfo& info,
    ...
    setDisplayProjection(t, dpy, info);
